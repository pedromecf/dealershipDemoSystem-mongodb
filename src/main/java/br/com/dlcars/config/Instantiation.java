...
public class Instantiation implements CommandLineRunner {
	...
	*/
	...
	public void run(String... args) throws Exception {
		...
		Client cl1 = new Client("01", "Pedro Guilherme Maia Colombano", "540384653", "42699178810", "", "pedromecf@gmail.com", "Rua street, 140", 50000.0);
		Client cl2 = new Client("02", "Fulano da Silva Cicrano", "302784639","76449564091", "", "fulano@outlook.com", "Avenida Paulista, 123",  1000000.0);
		Client cl3 = new Client("03", "Thomas Turbano", "149384555", "", "42571733000126", "thomas@gmail.com", "Rua Avenue, 233", 679240.45);
